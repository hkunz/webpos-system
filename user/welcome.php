...
<body class="body" style='overflow:hidden'>
  ...
  <div class="container-left" style='max-height:<?php echo ($ismobile) ? "100%" : "450px" ?>px;max-width:<?php echo ($ismobile) ? "100%" : "100%" ?>;margin-bottom:15px;'>
    ...
    <div>
      <img class="welcome-image" src="<?php echo $href_root; ?>/assets/imgs/logo.png" style='min-width:200px;max-width:100%;width:100%;'>
    </div>
  </div>
  </div>
