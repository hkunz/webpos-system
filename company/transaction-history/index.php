...
<html lang="en">
  ...
  <script type="text/javascript" src="js/TransactionHistoryHandler.js"></script>
...
<body class="body">
  ...
  <div class="container-wrapper">
	...
	<table id='header_table' cellpadding='0' cellspacing='0' style='width:100%;'>
          <tr>
            <td style='width:100%;'>
              <label class="drop-shadow" style="font-weight:bold;">VIEW TRANSACTION: </label><label id='colon_label' class="drop-shadow" style="display:none;font-weight:bold;"></label>
