...
$query = "SELECT `transaction_id` `Transaction-ID`,`date` `Date Time`,`grand_total` `Grand Total`,`payment` `Payment` FROM `items_transactions` WHERE customer='$customer' AND type='SALE' AND payment < grand_total ORDER BY `date` DESC";
