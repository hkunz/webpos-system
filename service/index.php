...
<body class="body">
  ...
  <div class="container-wrapper hide-scroll" <?php if ($ismobile) echo "style='display:block;overflow-y:scroll;'"; ?>>
    <div class="container-left<?php if ($ismobile) echo '-mobile'; ?> hide-scroll" style="<?php echo ($ismobile) ? "padding-bottom:0px;" : "margin-right:20px;overflow-y:scroll;display:block;"; ?>">
